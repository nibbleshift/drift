...
func (lc *LinkCreate) SetData(s string) *LinkCreate {
...
func (lc *LinkCreate) check() error {
	...
	if _, ok := lc.mutation.Data(); !ok {
		return &ValidationError{Name: "data", err: errors.New(`ent: missing required field "Link.data"`)}
	}
	return nil
}
...
func (lc *LinkCreate) createSpec() (*Link, *sqlgraph.CreateSpec) {
	...
	if value, ok := lc.mutation.Data(); ok {
		_spec.SetField(link.FieldData, field.TypeString, value)
		_node.Data = value
	}
	return _node, _spec
}
...
// SetData sets the "data" field.
func (u *LinkUpsert) SetData(v string) *LinkUpsert {
	u.Set(link.FieldData, v)
	return u
}

// UpdateData sets the "data" field to the value that was provided on create.
func (u *LinkUpsert) UpdateData() *LinkUpsert {
	u.SetExcluded(link.FieldData)
	return u
}
...
// SetData sets the "data" field.
func (u *LinkUpsertOne) SetData(v string) *LinkUpsertOne {
	return u.Update(func(s *LinkUpsert) {
		s.SetData(v)
	})
}
...
// UpdateData sets the "data" field to the value that was provided on create.
func (u *LinkUpsertOne) UpdateData() *LinkUpsertOne {
	return u.Update(func(s *LinkUpsert) {
		s.UpdateData()
	})
}
...
// SetData sets the "data" field.
func (u *LinkUpsertBulk) SetData(v string) *LinkUpsertBulk {
	return u.Update(func(s *LinkUpsert) {
		s.SetData(v)
	})
}
...
// UpdateData sets the "data" field to the value that was provided on create.
func (u *LinkUpsertBulk) UpdateData() *LinkUpsertBulk {
	return u.Update(func(s *LinkUpsert) {
		s.UpdateData()
	})
}
